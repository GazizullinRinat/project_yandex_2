...
def add_order():
    ...
    print(dishes, 'QAWREGT')
    print(session.get("new_order_dishes"))
...
def get_history():
    current_orders = sorted(Order.query.filter_by(state="closed", user_id=current_user.id), key=lambda i: i.date)
